...
@Component({
  selector: 'app-view-nodes-direct-connections-inverse',
  templateUrl: './view-nodes-direct-connections-inverse.component.html',
  styleUrls: ['./view-nodes-direct-connections-inverse.component.scss']
})
export class ViewNodesDirectConnectionsInverseComponent implements OnInit {
